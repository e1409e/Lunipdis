...
-- Tiempo de generación: 03-07-2024 a las 13:51:26
...
(18, 1, '2024-06-13', 'rutina'),
(19, 1, '2024-06-13', 'rutina'),
(20, 1, '2024-06-26', 'rutina'),
(21, 1, '2024-06-21', 'rutina');
...
INSERT INTO `estudiantes` (`id_estudiante`, `nombres`, `apellidos`, `cedula`, `telefono`, `correo`, `nombre_contacto`, `telefono_contacto`, `discapacidad_id`, `fecha_nacimiento`, `observaciones`, `seguimiento`, `fecha_registro`) VALUES
(1, 'Eric', 'Chaparro', '30474879', '0412-8792562', 'ericchaparro879@ujgh.edu.ve', 'Jose Miguel', '0424-6598123', 2, '2003-09-14', 'normal', 'normal', '2023-05-22'),
(2, 'Antonio', 'Lopez', '29356879', '0412-5687912', 'antoniolopez879@ujgh.edu.ve', 'Juliana vargas', '0414-7894532', 1, '1998-05-15', 'anormal', 'anormal', '2024-06-13'),
(3, 'Jose', 'Peréz', '26497516', '0424-6547823', 'joseperéz823@ujgh.edu.ve', 'Juan Peréz', '0416-7531937', 1, '1994-02-22', 'casi normal', 'casi normal', '2022-03-05'),
(5, 'Victor', 'Chacin', '30456173', '0412-8794596', 'victor@gmail.com', 'Ofelia Barboza', '0412-8722654', 2, '2004-11-02', 'normal', 'normal', '2024-02-21'),
(21, 'Martin', 'Sanchez', '28822144', '0412-6567988', 'martinsanchez144@ujgh.edu.ve', 'Paola Sanchez', '0412-3339465', 1, '2000-10-20', 'observacion de ejemplo', 'seguimiento de ejemplo', '2024-03-17');
...
CREATE TABLE `incidencias` (
  ...
  `lugar_incidente` text DEFAULT NULL,
...
INSERT INTO `incidencias` (`id_incidencia`, `id_estudiante`, `hora_incidente`, `fecha_incidente`, `lugar_incidente`, `descripcion_incidente`, `acuerdos`, `observaciones`) VALUES
...
(7, 21, NULL, NULL, NULL, NULL, NULL, 'ejemplo'),
(8, 3, '12:03:00', '2024-07-12', 'ejemplo lugar', 'ejemplo', 'ejemplo', 'ejemplo'),
(9, 1, '09:04:00', '2024-07-28', 'ejemplo lugar', 'aaaa', 'eeee', 'tttttt');
...
INSERT INTO `padres` (`id_padres`, `nombre_contacto`, `tipo_familiar`, `cedula_padre`, `lugar_nacimiento`, `fecha_nacimiento`, `direccion_habitacion`, `telefono_contacto`, `lugar_trabajo`, `estado`, `municipio`, `departamento`, `estado_civil`, `id_estudiante`) VALUES
...
(6, '', 'Madre', 13778644, 'Ejemplo', '1978-07-23', 'Direccion de Ejemplo', '0414-5658794', 'Ejemplo de trabajo', 'Zulia', 'Maracaibo', 'Departamento de ejemplo', 'divorciado/a', 21);
...
--
-- Estructura de tabla para la tabla `reporte_psicologico`
--

CREATE TABLE `reporte_psicologico` (
  `id_psicologico` int(11) NOT NULL,
  `Nombre` varchar(20) NOT NULL,
  `Apellido` varchar(20) NOT NULL,
  `lugnac` varchar(100) NOT NULL,
  `fechnac` date NOT NULL,
  `edad` int(3) NOT NULL,
  `nv_ins` varchar(50) NOT NULL,
  `motivocon` text NOT NULL,
  `sintdiag` text NOT NULL,
  `recomendaciones` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `reporte_psicologico`
--

INSERT INTO `reporte_psicologico` (`id_psicologico`, `Nombre`, `Apellido`, `lugnac`, `fechnac`, `edad`, `nv_ins`, `motivocon`, `sintdiag`, `recomendaciones`) VALUES
(2, 'Jose', 'Pirela', 'maracaibo', '2024-04-18', 25, 'Bachillerato', 'ejemplo 3', 'ejemplo 1', 'ejemplo 2');
...
INSERT INTO `universidad` (`id_universidad`, `id_estudiante`, `carrera_id`, `facultad_id`, `periodo_id`) VALUES
(1, 1, 2, 2, 1),
(2, 2, 3, 3, 1),
(3, 3, 6, 1, 1),
(4, 21, 6, 1, 1);
...
--
-- Indices de la tabla `reporte_psicologico`
--
ALTER TABLE `reporte_psicologico`
  ADD PRIMARY KEY (`id_psicologico`);
...
--
ALTER TABLE `citas`
  MODIFY `id_citas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `padres`
  MODIFY `id_padres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de la tabla `reporte_psicologico`
--
ALTER TABLE `reporte_psicologico`
  MODIFY `id_psicologico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
