    ...
    <div class="col-md-4 mx-auto">
      ...
      <form action="" method="POST" class="row justify-content-center align-items-center">
        ...
        <div class="form-group">
          <input name="fecha_cita" type="date" class="form-control" value="{{$cita->fecha_cita}}">
        </div>
        <div class="form-group">
        <textarea name="motivo_cita" class="form-control mt-2" cols="30" rows="5">{{$cita->motivo_cita}}</textarea>
        </div>
